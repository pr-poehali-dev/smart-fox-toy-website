          ...
          <div className="flex justify-center gap-6 mb-6">
            ...
            <a href="#" className="text-white/70 hover:text-white transition-colors">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                <path d="M15.07 2H8.93C3.33 2 2 3.33 2 8.93v6.14C2 20.67 3.33 22 8.93 22h6.14c5.6 0 6.93-1.33 6.93-6.93V8.93C22 3.33 20.67 2 15.07 2zm3.91 14.18h-1.72c-.39 0-.51-.24-.51-.48 0-.29.15-.48.41-.48.18 0 .35.07.48.19.12.11.21.18.36.18.21 0 .39-.17.39-.39 0-.13-.06-.25-.15-.33-.29-.26-.68-.41-1.08-.41-.88 0-1.59.71-1.59 1.59 0 .61.32 1.14.81 1.43-.19.29-.52.48-.89.48h-3.38c-.88 0-1.59-.71-1.59-1.59v-.82h2.72c.29 0 .52-.23.52-.52s-.23-.52-.52-.52h-2.72v-.82c0-.29-.23-.52-.52-.52s-.52.23-.52.52v.82H7.41c-.29 0-.52.23-.52.52s.23.52.52.52h2.72v.82c0 1.45 1.18 2.63 2.63 2.63h3.38c.74 0 1.42-.31 1.9-.81.17.05.34.07.53.07h1.72c.29 0 .52-.23.52-.52s-.23-.52-.52-.52z"/>
              </svg>
            </a>
            <a href="#" className="text-white/70 hover:text-white transition-colors">
